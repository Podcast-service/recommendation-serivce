...
@Entity
@Table(name = "user_author_interest")
public class UserAuthorInterestEntity {

    @EmbeddedId
    private UserAuthorInterestId id;
    ...
    protected UserAuthorInterestEntity() {
    }

    public UserAuthorInterestEntity(String userId, String authorId, Instant now) {
        this.id = new UserAuthorInterestId(userId, authorId);
